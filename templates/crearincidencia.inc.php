...
?>
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" style="margin: 0 auto; width: 95%;">
<input type="hidden" name="operacion" value="crearincidencia"/>
<input type="hidden" name="operacion2" value="1"/>

<div class="form-group row">
 <div class="col-xs-12<?php if ($ERROR['nombre']) echo $ERROR_INPUT_CLASSNAME;?> col-md-5">
 ...
 <div class="col-xs-12<?php if ($ERROR['email']) echo $ERROR_INPUT_CLASSNAME;?> col-md-5">
 ...
 <div class="col-xs-12<?php if ($ERROR['urgencia']) echo $ERROR_INPUT_CLASSNAME;?> col-md-2">
...
<div class="form-group row">
 <div class="col-xs-12<?php if ($ERROR['textoincidencia']) echo $ERROR_INPUT_CLASSNAME;?> col-md-12">
